...
public class Caracteristicas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tamanho da Memória Principal:  32 Quadros");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/a.png"))); // NOI18N

        jLabel3.setText("Tamanho da Tabela de Páginas: 10 Páginas");

        jLabel4.setText("Quadro:  4KB");

        jLabel5.setText("Página: 4 KB");

        jLabel6.setText("Processo");

        jLabel7.setText("Mínimo: 4 Páginas");

        jLabel8.setText("Máximo: 16 Páginas");

        jLabel9.setText("Tamanho da TLB: 6 Páginas");

        jLabel10.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("Características");

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/application_xp_terminal.png"))); // NOI18N
